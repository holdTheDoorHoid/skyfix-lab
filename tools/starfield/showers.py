...
def build() -> int:
    ...
    header = ("# Generated by tools/starfield/showers.py from tools/starfield/showers_table.txt;\n"
              "# do not edit by hand. Display-only data (CONVENTIONS 13.6). Meteor showers:\n"
              "# SkyFix Lab's own table, compiled from IAU MDC and IMO published values.\n"
              "# iau|code|name|lambda_start|lambda_peak|lambda_end (J2000 solar longitude, deg)|\n"
              "# ra|dec (radiant at the peak, J2000 deg)|dra|ddec (deg per deg of solar longitude)|\n"
              "# v_inf (km/s)|r|zhr|variable (0/1)|parent\n")
