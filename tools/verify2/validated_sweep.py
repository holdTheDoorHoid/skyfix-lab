...
PUBLISHED_LABELLED_ARCMIN = {"Mercury": 0.005, "Venus": 0.005, "Mars": 0.02, "Jupiter": 0.02, "Saturn": 0.02}
def one(args):
    b, jd_tt_guess = args
...
cases = []
for b in bodies:
    for (y0, y1) in [(1550, 1800), (1800, 1969), (1970, 2300), (2300, 2650)]:
...
json.dump(res, open(f"vsweep_{'_'.join(bodies)}.json", "w"))
for b in bodies:
