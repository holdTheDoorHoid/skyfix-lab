...
| Core-module size | noted | The package adds 214 KB raw and 87 KB gzipped (mostly code: E5, the searches, the MPC parser, the serialisation of eleven calls); a lazily loaded second module is the lever if the budget tightens |
