...
| Series: VSOP87A with fitted corrections, ELP/MPP02 with refitted secular terms, long-term precession, full nutation arguments | completed | one compact file, `series.bin` (162 507 bytes); validated tier Sun 0.01″, Moon 0.36″, planets 0.04″ (Mercury) to 0.91″ (Uranus) against DE440 |
