...
export const VIEW_META: Record<ViewId, ViewMeta> = {
  ...
  navigate: {
    ...
    label: 'Navigate',
    icon: 'sextant',
    tip: 'Sights and the fix, noon and Polaris sights, lunars, the compass and a passage',
    title: 'Navigate',
  },
  almanac: {
    tab: 'almanac',
    label: 'Almanac',
    icon: 'almanac',
    tip: 'The daily pages and the almanac’s tables, ready to print',
    title: 'Almanac',
  },
  events: {
    tab: 'events',
    label: 'Events',
    icon: 'events',
    tip: 'Eclipses, the Moon, planet events, meteor showers and the seasons',
    title: 'Events',
  },
  learn: {
    tab: 'learn',
