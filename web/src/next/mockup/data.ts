...
// ---------------------------------------------------------------------------------
// The same evening at 19:35 EDT (23:35 UTC): nautical twilight, the Moon selected.
// ---------------------------------------------------------------------------------

export const EVENING_JD = at(19 + 35 / 60);

/** The Sun's ground point at 19:35 EDT (for the map's shading). */
export const EVENING_SUBSOLAR: [number, number] = [-0.768, -175.79];

/** The Moon tonight: rise and transit today, set tomorrow morning (hours after today's midnight). */
export const MOON_TONIGHT = {
  rise: { h: 17.9114, az: 99.35 },
  transit: { h: 23.6741, alt: 43.731 },
  set: { h: 29.6086, az: 264.51 },
};

/** Previous new Moon, 2026-09-11 03:34 UTC (for the Moon's age). */
export const PREVIOUS_NEW_MOON_JD = 2461294.648937861;

/** sky_state(...) at 19:35 EDT: the solar-system bodies and the brightest stars that are up. */
export const EVENING_BODIES: MockBody[] = [
  { body: 'Vega', kind: 'star', alt: 87.46, az: 244.18, gha: 78.102, dec: 38.808, gp: [38.808, -78.102], magnitude: 0.03 },
  { body: 'Deneb', kind: 'star', alt: 68.7, az: 65.96, gha: 46.976, dec: 45.377, gp: [45.377, -46.976], magnitude: 1.25 },
  { body: 'Altair', kind: 'star', alt: 56.01, az: 151.59, gha: 59.544, dec: 8.938, gp: [8.938, -59.544], magnitude: 0.76 },
  { body: 'Arcturus', kind: 'star', alt: 28.66, az: 271.61, gha: 143.333, dec: 19.059, gp: [19.059, -143.333], magnitude: -0.05 },
  {
    body: 'Moon',
    kind: 'moon',
    alt: 17.3,
    ...
    magnitude: -12.18,
    illuminated: 0.967,
    // bright_limb_angle_deg 250.2 minus parallactic_angle_deg -44.1
    limbFromUp: 294.3,
    distance_km: 386920,
    sd_arcmin: 15.44,
    hp_arcmin: 56.67,
  ...
  { body: 'Antares', kind: 'star', alt: 16.2, az: 211.98, gha: 109.799, dec: -26.489, gp: [-26.489, -109.799], magnitude: 1.06 },
  { body: 'Neptune', kind: 'planet', alt: 7.0, az: 95.93, gha: 354.233, dec: -0.105, gp: [-0.105, 5.767], magnitude: 7.81 },
  { body: 'Venus', kind: 'planet', alt: 1.99, az: 241.9, gha: 144.936, dec: -19.999, gp: [-19.999, -144.936], magnitude: -4.56, illuminated: 0.204 },
  { body: 'Saturn', kind: 'planet', alt: 1.93, az: 88.36, gha: 345.356, dec: 2.299, gp: [2.299, 14.644], magnitude: 0.68 },
  { body: 'Mercury', kind: 'planet', alt: 0.31, az: 257.56, gha: 157.263, dec: -9.636, gp: [-9.636, -157.263], magnitude: -0.16 },
  { body: 'Sun', kind: 'sun', alt: -7.98, az: 276.28, gha: 175.79, dec: -0.768, gp: [-0.768, -175.79], magnitude: -26.73 },
  { body: 'Uranus', kind: 'planet', alt: -18.47, az: 38.09, gha: 293.83, dec: 21.086, gp: [21.086, 66.17], magnitude: 5.64 },
  { body: 'Jupiter', kind: 'planet', alt: -22.94, az: 318.94, gha: 216.428, dec: 15.829, gp: [15.829, 143.572], magnitude: -1.85 },
  { body: 'Mars', kind: 'planet', alt: -25.71, az: 341.23, gha: 237.119, dec: 21.424, gp: [21.424, 122.881], magnitude: 1.16 },
];

/** Navigational stars above the horizon at 19:35 EDT. */
export const EVENING_STARS_ABOVE = 26;

/** The Moon's apparent altitude and azimuth every 10 minutes from 17:00 today to 07:00 tomorrow. */
export const MOON_PATH_START_H = 17;
export const MOON_PATH_ALT: number[] = [
  -10.42, -8.54, -6.67, -4.79, -2.92, -1.05, 0.62, 2.3, 4.06, 5.84, 7.63, 9.42, 11.2, 12.97, 14.72, 16.45, 18.15, 19.84, 21.49,
  23.12, 24.72, 26.27, 27.79, 29.27, 30.7, 32.08, 33.41, 34.68, 35.88, 37.02, 38.08, 39.07, 39.97, 40.79, 41.52, 42.15, 42.68,
  43.11, 43.43, 43.64, 43.75, 43.74, 43.62, 43.39, 43.05, 42.61, 42.07, 41.42, 40.69, 39.86, 38.94, 37.95, 36.88, 35.74, 34.53,
  33.26, 31.94, 30.56, 29.13, 27.66, 26.15, 24.6, 23.02, 21.4, 19.76, 18.09, 16.4, 14.69, 12.96, 11.22, 9.46, 7.7, 5.94, 4.18,
  2.45, 0.8, -0.81, -2.64, -4.47, -6.3, -8.12, -9.95, -11.77, -13.59,
];
export const MOON_PATH_AZ: number[] = [
  91.06, 92.58, 94.09, 95.6, 97.11, 98.63, 100.16, 101.7, 103.25, 104.82, 106.42, 108.03, 109.68, 111.36, 113.07, 114.82, 116.61,
  118.45, 120.34, 122.28, 124.27, 126.34, 128.46, 130.66, 132.92, 135.27, 137.69, 140.2, 142.79, 145.47, 148.23, 151.08, 154.02,
  157.03, 160.13, 163.29, 166.52, 169.8, 173.12, 176.47, 179.85, 183.23, 186.6, 189.95, 193.27, 196.55, 199.77, 202.93, 206.01,
  209.02, 211.95, 214.8, 217.56, 220.24, 222.83, 225.34, 227.77, 230.12, 232.39, 234.6, 236.74, 238.82, 240.83, 242.8, 244.71,
  246.57, 248.4, 250.18, 251.93, 253.64, 255.33, 256.99, 258.64, 260.26, 261.87, 263.47, 265.06, 266.65, 268.24, 269.83, 271.42,
  273.02, 274.63, 276.26,
];
